...
<html>
<head>
<title>I-T&T | ISHA Tours And Travels</title>
...
<div class="banner">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> I-T&T | ISHA Tours And Travel</h1>
	</div>
</div>
...
<div class="container">
	<div class="rupes">
		<div class="col-md-4 rupes-left wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
			<div class="rup-left">
				<a href="offers.php"><i class="fa fa-inr"></i></a>
			</div>
			<div class="rup-rgt">
				<h3>UP TO ₹ 600 OFF</h3>
